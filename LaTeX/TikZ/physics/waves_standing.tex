...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,0) {$n=1$\\$\lambda=2L$};
  \draw[<->] (0,-1.3*\A) --++ (\L,0)
...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,0) {$n=2$\\$\lambda=L$};
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,0) {$n=3$\\[1mm]$\lambda=\dfrac{3L}{4}$};
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,0) {$n=4$\\[1mm]$\lambda=\dfrac{L}{2}$};
\end{tikzpicture}
...
\begin{tikzpicture}
  \wave{1}
  \node[align=left] at (1.23*\L,0) {$n=1$\\$\lambda=4L$};
  \draw[<->] (0,-1.3*\A) --++ (\L,0)
...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,-0.2*\A) {$n=3$\\[1mm]$\lambda=\dfrac{4L}{3}$};
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,-0.2*\A) {$n=5$\\[1mm]$\lambda=\dfrac{4L}{5}$};
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \node[align=left] at (1.23*\L,-0.2*\A) {$n=7$\\[1mm]$\lambda=\dfrac{4L}{7}$};
\end{tikzpicture}
