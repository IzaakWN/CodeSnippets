...
\def\engine#1{
  ...
  \begin{scope}[shift={(-2.7,\hSR+\hRP)}]
    ...
    \draw[mydarkblue,thick,
          top color=blue!30!black!70,bottom color=blue!30!black!60,middle color=blue!30!black!30,shading angle=0]
  ...
  \begin{scope}[shift={(0,{\hRP*(1/sin(\a)-1)})}]
    \draw[blue!30!black,thick,top color=blue!40!black!40,bottom color=blue!40!black!60,shading angle=0]
  ...
  % PLATFORM
  \draw[blue!20!black,thick,
        top color=blue!40!black!90,bottom color=blue!20!black!90,shading angle=10]
    (-\Sw/2,0) --++ (0,-1) --++ (\Sw,0) --++ (0,1+\Sh) --++ (2.2,0) --++ (0,-2-\Sh) --++ (-\Sw-5.2,0) --++ (0,2) -- cycle;
}
...
\begin{tikzpicture}[scale=0.9]
  ...
  \node[right=14,above right=1,mydarkblue] at (NE) {$P_1$, $V_1$};
  \mass{0,0}
  \draw[->,very thick,mydarkblue] (E) ++ (0.4,0) --++ (1.4,0);
  \draw[->,very thick,mydarkblue] ($(ST)+(-.4,.3)$) --++ (0,1.2);
  \fire
\end{tikzpicture}
