...
\begin{tikzpicture}
  ...
  \draw[->,vcol!70!black] (\ang+30:0.6*\R) arc(\ang+20:\ang+70:0.4*\R) node[midway,above] {$\omega$};
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \fill[red!50!black] (R) circle (0.1);
  \draw[->,vcol!70!black] (\ang+30:0.5*\R) arc(\ang+20:\ang+70:0.4*\R) node[midway,above left=-2] {$2\omega$};
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  \fill[red!50!black] (R) circle (0.1);
  \draw[->,vcol!70!black] (\ang+60:1.4*\R) arc(\ang+60:\ang+100:1.1*\R) node[midway,left=-1] {$\omega$};
\end{tikzpicture}
