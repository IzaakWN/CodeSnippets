...
\tikzstyle{thick vector}=[->,veccol,line width=2]
\tikzstyle{mu vector}=[->,thick,mucol]
\tikzstyle{velocity}=[->,very thick,veccol]
...
\begin{tikzpicture}
  ...
  \draw[BField,very thick,rotate=-15]
    (O)++(-250:{\Rx} and {\Ry}) arc (-250:-80:{\Rx} and {\Ry})
