...
\begin{tikzpicture}
  ...
  % PLOT
  \draw[EField,samples=100,smooth,variable=\x,domain={1.1*\kQ/\ymax}:0.98*\xmax]
    plot(\x,\kQ/\x);
  \node[above right] at (1.4,1.8) {$E \sim \dfrac{1}{y}$};
...
\begin{tikzpicture}
  ...
  \draw[EField,samples=100,smooth,variable=\x,domain={1.1*\kQ/\ymax}:0.98*\xmax]
    plot(\x,\kQ/\x);
  \draw[black!70,thin,dashed,black,samples=100,smooth,variable=\x,domain={sqrt(1.1*\kQ/\ymax)}:0.98*\xmax]
    plot(\x,\kQ/\x^2);
...
\begin{tikzpicture}
  ...
  % PLOT
  \draw[EField,samples=100,smooth,variable=\x,domain=0:0.98*\xmax]
    plot(\x,\kQ);
  \draw[black!60,thin,dashed,black,samples=100,smooth,variable=\x,domain={sqrt(1.1*\kQ/\ymax)}:0.98*\xmax]
    plot(\x,\kQ/\x^2);
...
\begin{tikzpicture}
  ...
  \draw[EField,samples=100,smooth,variable=\x,domain=0:\R]
    plot(\x,\kQ*\x/\R^3);
  \draw[EField,samples=100,smooth,variable=\x,domain=\R:0.98*\xmax]
    plot(\x,\kQ/\x^2);
  \node[scale=0.9] at (0.75,2.5) {$E \sim \dfrac{r}{R^3}$};
...
\begin{tikzpicture}
  ...
  \draw[EField,samples=100,smooth,variable=\x,domain=\Rout:0.98*\xmax]
    plot (\x,\kQ/\x^2);
  \node[above right] at (2.1,2.3) {$E \sim \dfrac{1}{r^2}$};
