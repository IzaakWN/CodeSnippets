...
\begin{tikzpicture} %[x=(15:0.5), y=(90:0.6), z=(-20:2.2)]
  ...
  \def\anga{-15} % angle beam 1
  \def\angb{-13} % angle beam 2 (mostly parallel)
  ...
  \begin{scope}[shift={(0.61*\L,0)}]
    ...
    \draw[thin,line cap=round] (SH)++(-85:0.015*\h) to[out=-115,in=-140,looseness=2]++ (-0.14*\h,0.23*\h);
    \draw[thin,line cap=round] (SH)++(-85:0.015*\h) to[out=-60,in=90]++ (0.5*\w,-0.4*\h);
