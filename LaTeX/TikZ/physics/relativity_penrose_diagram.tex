  ...
  \node[align=left] at (0,0) {
    \begin{minipage}{9.5cm}
      ...
      \begin{align*}
        ...
        \end{cases}\\[1mm]
        &\Rightarrow\begin{cases}
          U^2 - V^2 = \left(\dfrac{r}{2GM}-1\right)e^{\frac{r}{2GM}} \hspace{-10mm} \\[3mm]
          V = \tanh\left(\dfrac{t}{4GM}\right)U & \text{for $r>2GM$} \\[3mm]
          V = \coth\left(\dfrac{t}{4GM}\right)U & \text{for $r<2GM$}
        \end{cases}
      \end{align*}
      Penrose coordinates for Schwarzschild spacetime
      \begin{align*}
        &\left\{\begin{aligned}
          U + V = \tan(u+v) \\
          U - V = \tan(u-v) \\
...
\begin{tikzpicture}[scale=3.2]
  ...
  \draw[photon] (X0) ++ (135:0.1) --++ (135:0.4);
  \draw[photon] (X1) ++ (45:0.1) --++ (45:0.3);
  \draw[photon] (X1) ++ (135:0.1) --++ (135:0.14);
...
\begin{tikzpicture}[scale=3.2]
  ...
  % PHOTONS
  \draw[photon] (X0) ++ (45:0.1) --++ (45:0.3);
  \draw[photon] (X0) ++ (135:0.1) --++ (135:0.3);
  \draw[photon] (X1) ++ (45:0.1) --++ (45:0.3);
  \draw[photon] (X1) ++ (135:0.1) --++ (135:0.14);
