...
\begin{tikzpicture}[scale=0.9]
  ...
  \begin{scope}[shift={({-0.46*\hcl},0)}, rotate=1]
    ...
    \draw[->-,densely dashed,thick] % pion0
  ...
  \begin{scope}[shift={({0.64*\hcl},0)}, rotate=-6]
    ...
    \draw[->-,thick] % pion 1
      ...
      pic[rotate=16,scale=1.2] {mycone};
    \draw[->-,       thick] % pion 2
      (rho) --+ (86:2.8) node[right=6,above=40] {$\pi^\mp$}
      pic[rotate=0,scale=1.2] {mycone};
    \draw[->-,thick] % pion 3
    ...
    \draw[photon] % photon 1
      ...
      pic[rotate=-19,xscale=0.8] {mycone};
    \draw[photon] % photon 2
...
% TAU DECAY MODES - DM0, DM1, DM10 only
\begin{tikzpicture}[scale=0.9]
