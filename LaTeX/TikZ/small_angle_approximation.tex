...
\begin{tikzpicture}
  ...
  \node[right=2,below left=1.4] at (0,0) {$0$};
  \tick{0,-\A}{0} node[left=-1,scale=1] {$-1$};
  \tick{0,\A}{0} node[left=-1,scale=1] {$1$};
  \foreach \i [evaluate={\ang=int(\i*105/\N); \t=pi/180/\k*\ang;}] in {1,...,\N}{
    \tick{-\t,0}{90} node[left=2,below=-1,scale=1] {$-\ang$};
    \tick{\t,0}{90} node[below=-1,scale=1] {$\ang$};
  }
...
\begin{tikzpicture}
  ...
  \node[right=1,below left=1] at (0,0) {$0$};
  \foreach \i [evaluate={\ang=int(\i*25/\Nx); \t=pi/180/\k*\ang;}] in {1,...,\Nx}{
    \tick{-\t,0}{90} node[left=2,below=-1,scale=1] {$-\ang$};
    \tick{\t,0}{90} node[below=-1,scale=1] {$\ang$};
  }
  \foreach \i [evaluate={\rd=int(3*\i/\Ny); \y=\A*\rd/1000;}] in {1,...,\Ny}{
    \tick{0,-\y}{0} node[left=-1,scale=1] {$-0.\rd$};
    \tick{0,\y}{0} node[left=-1,scale=1] {$0.\rd$};
  }
