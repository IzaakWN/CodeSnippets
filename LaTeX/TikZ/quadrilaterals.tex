...
\tikzstyle{myset}=[draw=mydarkred,fill=mydarkred!3,rounded corners=4,line width=0.55]
...
\def\commontraps{       % trapezia common in each picture
  ...
  \begin{scope}[shift={(\xsquare*\W,\ysquare*\H)}]
    ...
    \pic[angcol=myblue] {right angle={(SE)-(SW)-(NW):0.25}};
    \pic[angcol=myblue] {right angle={(SW)-(NW)-(NE):0.25}};
    \pic[angcol=myblue] {right angle={(NW)-(NE)-(SE):0.25}};
    \pic[angcol=myblue] {right angle={(NE)-(SE)-(SW):0.25}};
  ...
  \begin{scope}[shift={(-0.5*\W,\H)}]
    ...
    %\pic[nmarks=1,angcol=myred]   {mark angle={(SE)-(SW)-(NW):0.25}};
    %\pic[nmarks=2,angcol=mygreen] {mark angle={(SW)-(NW)-(NE):0.25}};
    %\pic[nmarks=1,angcol=myred]   {mark angle={(NW)-(NE)-(SE):0.25}};
    %\pic[nmarks=2,angcol=mygreen] {mark angle={(NE)-(SE)-(SW):0.25}};
    \coordinate (S) at (0,0);
    ...
    \pic[nmarks=2,angcol=mygreen] {mark angle={(W)-(N)-(E):0.25}};
    \pic[nmarks=2,angcol=mygreen] {mark angle={(E)-(S)-(W):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(N)-(E)-(S):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(S)-(W)-(N):0.25}};
  ...
  \begin{scope}[shift={(1.5*\W,\H)}]
    ...
    \draw[myshape] (SW) -- (SE) -- (NE) -- (NW) -- cycle;
    \pic[nmarks=2,angcol=mygreen] {mark angle={(SW)-(NW)-(NE):0.25}};
    \pic[nmarks=2,angcol=mygreen] {mark angle={(NW)-(NE)-(SE):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(SE)-(SW)-(NW):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(NE)-(SE)-(SW):0.25}};
...
\def\commonkites{ % common kites in each picture
  ...
  \begin{scope}[shift={(\xkite*\W,\H)}]
    ...
    \pic[angcol=myblue]  {right angle={(S)-(W)-(N):0.25}};
    \pic[angcol=myblue]  {right angle={(N)-(E)-(S):0.25}};
...
\def\commonangtraps{
  ...
  \begin{scope}[shift={(-0.5*\W,\yrighttrap*\H)}]
    ...
    \draw[myshape] (SW) -- (SE) -- (NE) -- (NW) -- cycle;
    \pic[angcol=mygreen] {mark angle={(SE)-(SW)-(NW):0.25}};
    \pic[angcol=mygreen] {mark angle={(NW)-(NE)-(SE):0.25}};
    \pic[angcol=myred]   {mark angle={(SW)-(NW)-(NE):0.25}};
    \pic[angcol=myred]   {mark angle={(NE)-(SE)-(SW):0.25}};
  \end{scope}
  ...
  \begin{scope}[shift={(1.5*\W,\yrighttrap*\H)}]
    ...
    \draw[myshape] (SW) -- (SE) -- (NE) -- (NW) -- cycle;
    \pic[angcol=mygreen] {mark angle={(SW)-(NW)-(NE):0.25}};
    \pic[angcol=mygreen] {mark angle={(NW)-(NE)-(SE):0.25}};
    \pic[angcol=myred]   {mark angle={(SE)-(SW)-(NW):0.25}};
    \pic[angcol=myred]   {mark angle={(NE)-(SE)-(SW):0.25}};
  \end{scope}
...
\def\commonquads{ % common quadrilaterals in each picture
  ...
  \begin{scope}[shift={(\R+\W*\xybicent*\H+\R)}]
    ...
    \draw[mydarkgreen] (Oout) circle(\R+0.015);
    \draw[myshape] (SW) -- (SE) -- (NE) -- (NW) -- cycle;
    \draw[mydarkorange] (Oin) circle(\r-0.014);
  ...
  \begin{scope}[shift={(\xkite*\W,\ytangent*\H+\R)}]
    ...
    \draw[myshape] (S) -- (W) -- (N) -- (E) -- cycle;
    \draw[mydarkorange] (O) circle(\R-0.015);
  ...
  \begin{scope}[shift={(\xkite*\W,\ydart*\H)}]
    \node[below=-6,align=center] at (0,0) {dart};
    ...
    \draw[purple line] (E) -- (N) -- (W);
    \pic[nmarks=1,angcol=myred] {mark angle={(S)-(E)-(N):0.34}};
    \pic[nmarks=1,angcol=myred] {mark angle={(N)-(W)-(S):0.34}};
  ...
  \begin{scope}[shift={(\W*\xycomplex*\H)}]
    ...
    \def\w{1.6} % width
    \def\h{0.8} % height
    \coordinate (complex-W) at (-0.1*\w,\h/2);
...
\begin{tikzpicture}[scale=1.1]
  ...
  \def\H{2.0}     % height of each row
  \def\W{2.2}     % width of column
...
\begin{tikzpicture}[scale=1.1]
  ...
  \begin{pgfonlayer}{back} % draw on back
    ...
    \draw[mygreenset] (parallelogram)++(-1.1,0.7) rectangle++ (2.2,-1.85*\H);
    \draw[myset] (2 trapezium) -- (acute trapezium);
    \draw[myset] (2 trapezium)++(-1.1,0.7) rectangle++ (2.2,-2.0*\H);
    \draw[black]
...
\begin{tikzpicture}[scale=1.1]
  ...
  \begin{pgfonlayer}{back} % draw on back
    ...
    \draw[myset] (kite)++(-1.0,0.9) rectangle++ (2.0,-1.85*\H);
    \draw[black]
      (square) -- (right kite) -- (kite)
      (square) -- (rhombus) -- (parallelogram) -- (trapezium)
      (square) -- (rectangle) -- (right trapezium) -- (trapezium)
...
\begin{tikzpicture}[scale=1.1]
  ...
  \begin{pgfonlayer}{back} % draw on back
    ...
    \draw[myorangeset] (kite)++(-0.9,0.7) rectangle++ (1.8,-1.85*\H);
    \draw[mygreenset] (parallelogram) -- (obtuse trapezium);
    \draw[mygreenset] (parallelogram)++(-1.1,0.7) rectangle++ (2.2,-1.82*\H);
    \draw[myset] (2 trapezium) -- (acute trapezium);
    \draw[myset] (2 trapezium)++(-1.1,0.7) rectangle++ (2.2,-2.0*\H);
    \draw[black]
...
\begin{tikzpicture}[scale=1.1]
  ...
  \begin{pgfonlayer}{back} % draw on back
    \draw[black]
      ...
      (simple) -- (quadrilateral) -- (complex);
    \draw[white,double=black,double distance=0.4,line width=0.5]
      (cyclic) -- (bicentric)
...
\begin{tikzpicture}[scale=1.1]
  ...
  \begin{pgfonlayer}{back} % draw on back
    \draw[myorangeset] (kite) -- (irregular);
    \draw[myorangeset]
      (tangential)++(-1.2,0.8) rectangle++ (1.76*\W,-2.7*\H);
    \draw[mygreenset] (parallelogram) -- (obtuse trapezium);
    \draw[mygreenset] (parallelogram)++(-1.1,0.7) rectangle++ (2.2,-1.74*\H);
    \draw[myset] (2 trapezium) -- (acute trapezium);
    \draw[myset] (2 trapezium)++(-1.1,0.7) rectangle++ (2.2,-1.9*\H);
    \draw[black]
      (square) -- (right kite) -- (kite) -- (tangential)
      (square) -- (rhombus) -- (parallelogram)
    ...
    \draw[mydarkorange!3,double=black,double distance=0.4,line width=0.5]
      (cyclic) -- (bicentric)
...
\begin{tikzpicture}[scale=1.1]
  ...
  \def\xycomplex{3.6,4.8} % xy position complex
  \def\xyquad{2.0,5.5}    % xy position complex
  ...
  \begin{scope}[shift={(3.1*\W,0)}]
    ...
    \draw[purple line] (SW) -- (NW) (SE) -- (NE);
    \pic[nmarks=1,angcol=myred] {mark angle={(SW)-(NW)-(O):0.25}};
    \pic[nmarks=1,angcol=myred] {mark angle={(O)-(NE)-(SE):0.25}};
    \pic[nmarks=1,angcol=myred] {mark angle={(O)-(SW)-(NW):0.25}};
    \pic[nmarks=1,angcol=myred] {mark angle={(NE)-(SE)-(O):0.25}};
    \pic[angcol=myblue] {right angle={(NW)-(O)-(SW):0.25}};
    \pic[angcol=myblue] {right angle={(SE)-(O)-(NE):0.25}};
  ...
  \begin{scope}[shift={(2.6*\W,\H)}]
    ...
    \draw[purple line] (SW) -- (NW) (SE) -- (NE);
    \pic[nmarks=2,angcol=mygreen] {mark angle={(SW)-(NW)-(O):0.25}};
    \pic[nmarks=2,angcol=mygreen] {mark angle={(NE)-(SE)-(O):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(O)-(SW)-(NW):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(O)-(NE)-(SE):0.25}};
    \pic[nmarks=1,markshift=0.08,myblue] {mark line={(NW)-(SE):90}};
    \pic[nmarks=1,markshift=0.08,myblue] {mark line={(SW)-(NE):90}};
  ...
  \begin{scope}[shift={(3.6*\W,\H)}]
    ...
    \pic[nmarks=1,angcol=myred] {mark angle={(O)-(SW)-(NW):0.25}};
    \pic[nmarks=1,angcol=myred] {mark angle={(NE)-(SE)-(O):0.25}};
    %\pic[nmarks=2,angcol=mygreen] {mark angle={(SE)-(O)-(NE):0.25}};
    %\pic[nmarks=2,angcol=mygreen] {mark angle={(NW)-(O)-(SW):0.25}};
    \pic[nmarks=1,markshift=0.08,myblue] {mark line={(NW)-(SE):90}};
    \pic[nmarks=1,markshift=0.08,myblue] {mark line={(SW)-(NE):90}};
    \pic[nmarks=2,mypurple] {mark line={(NW)-(SW):90}};
    \pic[nmarks=2,mypurple] {mark line={(NE)-(SE):90}};
  ...
  \begin{scope}[shift={(3.6*\W,2*\H)}]
    ...
    \pic[nmarks=2,angcol=mygreen] {mark angle={(SE)-(SW)-(O):0.25}};
    \pic[nmarks=2,angcol=mygreen] {mark angle={(O)-(SE)-(SW):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(NW)-(NE)-(O):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(O)-(NW)-(NE):0.25}};
  ...
  \begin{scope}[shift={(4.6*\W,2*\H)}]
    ...
    \draw[purple line] (SW) -- (NW) (SE) -- (NE);
    \pic[nmarks=2,angcol=mygreen] {mark angle={(SW)-(NW)-(O):0.25}};
    \pic[nmarks=2,angcol=mygreen] {mark angle={(O)-(NE)-(SE):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(NE)-(SE)-(O):0.25}};
    \pic[nmarks=1,angcol=myred]   {mark angle={(O)-(SW)-(NW):0.25}};
  ...
  \begin{pgfonlayer}{back} % draw on back
    ...
    \draw[black] % cyclic
      (convex cyclic) -- (cyclic) -- (concave cyclic)
      (cyclic) -- (quadrilateral);
    \draw[black] % complex quadrilaterals
      ...
      (crossed 2 trapezium) -- (concave cyclic) -- (complex-W);
    \draw[white,double=black,double distance=0.4,line width=0.5]
